...
Un ennemi qui charge **ne se jette pas dans le vide** : il s'arrête net au bord
en continuant de fixer Brad. Deux raisons — un ennemi qui se suicide en
poursuivant le joueur se lit comme un bug, et surtout le trou acquiert ainsi une
valeur de level design : il devient une zone sûre d'où observer et préparer son
approche.

Le **coureur** fait exception : s'il voit du sol atteignable de l'autre côté
(jusqu'à 96 px), il saute. C'est ce qui le rend réellement menaçant face au
Serra de base. La case « Les coureurs franchissent les trous » du panneau permet
de comparer les deux comportements en jeu.

### Orientation des sprites

Chaque type porte un `sensNatif` relevé sur la position des pupilles dans
l'image d'origine. Le **Serra** et le **Serra-Volant** sont dessinés tournés vers
la gauche ; le coureur, le Lourd et le Lanceur vers la droite. Sans cette
correction, un sprite dessiné vers la gauche apparaît à l'envers dès qu'il
...
- **Les ennemis déjà éliminés ne reviennent pas** quand Brad réapparaît. Sans ça,
  un joueur qui meurt juste après avoir nettoyé un groupe se retrouve à
  réapparaître au milieu de ce même groupe, ce qui transforme une mort en
  spirale. Seul un vrai redémarrage du niveau — la troisième mort d'affilée, ou
  la touche R — remet tout le monde en place.
